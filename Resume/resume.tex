...
\nameanddescript{Compass Regulatory}{~~(AgTech Compliance SaaS)~~|~~Founding Engineer}
\hfill\normal{Mar 2024 – Present}
...
\hfill\location{Santa Clara, CA}

\textline{\normal{Master of Science in Computer Science and Engineering}}{}{\normal{2019 – 2020}}

\hspace{18pt}
\normal{Thesis: Deep Learning Methods for Efficient Image Coding}

\textline{\normal{Bachelor of Science in Computer Science and Engineering}}{}{\normal{2015 – 2019}}
...
\skills{Frontend:}{React, Next.js, Tailwind CSS, Redux, jQuery, Bootstrap}

\skills{Backend:}{Django, FastAPI, Flask, GraphQL, PostgreSQL, SQLite, Redis, Celery}

\skills{Cloud/Devops}{AWS, Docker, Docker Compose, Git, GitHub Actions}
